-- Krishi Sutra schema (SIH 2026 / PS 26032)
-- TODO: postgres for production
...
CREATE TABLE farmers (
    ...
    -- mock NPCI mapper, aadhaar linked to this account
...
CREATE TABLE staff (
    ...
    centre_id    INTEGER,         -- NULL for superadmin
...
CREATE TABLE procurement_centres (
    ...
    -- how far behind the counter is, set by hand
...
CREATE TABLE transactions (
    ...
    payment_date    TEXT,
    gross_weight    REAL,                       -- quintals, with bags
    bags            INTEGER,
    bag_weight_kg   REAL,
    moisture        REAL,                       -- percent
    foreign_matter  REAL,                       -- percent
    grade_note      TEXT,                       -- reason when overriding the suggested grade
    -- see payments.py. payment_status is the older coarse version
...
CREATE TABLE payment_batches (
    ...
    centre_id  INTEGER,                         -- NULL = all centres
    staff_id   INTEGER,
...
CREATE TABLE booking_events (
    id         INTEGER PRIMARY KEY AUTOINCREMENT,
    booking_id INTEGER,                         -- NULL if the scan matched nothing
